...
export const ENEMY_STRIP_META: Record<string, { frameName: string; frames: number; cellSize: number; fps: number }> = {
    ...
    'brute-prime': { frameName: 'enemy_brute_prime_idle', frames: 6, cellSize: 128, fps: 6 },
    'aura-arc': { frameName: 'enemy_aura_arc_idle', frames: 6, cellSize: 128, fps: 8 },
    'bomber-mother': { frameName: 'enemy_bomber_mother_idle', frames: 6, cellSize: 128, fps: 7 },
    'splitter-swift': { frameName: 'enemy_splitter_swift_idle', frames: 6, cellSize: 128, fps: 10 },
    'warden-regen': { frameName: 'enemy_warden_regen_idle', frames: 6, cellSize: 128, fps: 6 },
    'void-colossus': { frameName: 'enemy_void_colossus_idle', frames: 8, cellSize: 224, fps: 8 },
    'energy-worm': { frameName: 'enemy_energy_worm_idle', frames: 8, cellSize: 224, fps: 10 },
    'frost-queen': { frameName: 'enemy_frost_queen_idle', frames: 8, cellSize: 224, fps: 8 },
    'inferno-lord': { frameName: 'enemy_inferno_lord_idle', frames: 8, cellSize: 224, fps: 7 },
    'void-weaver': { frameName: 'enemy_void_weaver_idle', frames: 8, cellSize: 224, fps: 8 },
