...
# ─── 武器 ───
WEAPONS = [
    ("storm-rifle",    "风暴步枪",  5.0,  3.0,  0,    0,    0,    "均衡"),
    ("split-barrel",   "裂变枪管",  5.0,  2.0,  0.4,  1.25, 0,    "散射穿透"),
    ("orbital-drone",  "轨道无人机",72,   0.36, 0,    0,    3.2,  "无人机"),
    ("rail-cannon",    "磁轨炮",    72,   0.7,  3.5,  0,    0,    "重穿"),
    ("nova-shotgun",   "新星霰弹",  4.0,  0.35, 0.2,  1.65, 0,    "散射"),
    ("ion-lance",      "离子长枪",  62,   0.77, 1.5,  0.15, 0,    "穿刺"),
    ("ember-smg",      "余烬冲锋枪",3.2,  1.65, 0.15, 0.45, 0,    "射速"),
    ("frost-beamer",   "霜束发射器",8.0,  2.0,  0.3,  0.3,  0,    "均衡"),
    ("void-needle",    "虚空针",    42,   1.05, 1.2,  0,    0,    "穿透"),
    ("sun-disc",       "日冕飞盘",  4.2,  0.38, 0.55, 0.7,  0.3,  "混合"),
    ("echo-bow",       "回声弓",    28,   1.18, 1.0,  0.6,  0,    "弹射"),
    ("plague-sprayer", "瘟疫喷射器",4.0,  4.0,  0,    0.85, 0,    "喷射"),
    ("gravity-hammer", "重力锤",    210,  0.30, 1.0,  0,    0.5,  "重爆发"),
    ("mirror-prism",   "镜像棱镜",  6.0,  1.2,  0.3,  1.2,  0.3,  "弹幕"),
    ("meteor-launcher","流星发射器",116,  0.55, 1.0,  0.5,  0,    "重爆发"),
    ("pulse-fan",      "脉冲扇",    3.2,  1.0,  0.2,  1.05, 0,    "扇形"),
    ("thorn-chain",    "荆棘链",    3.9,  0.42, 0.9,  0.25, 0.25, "链式"),
    ("star-scythe",    "星镰",      5.6,  0.36, 0.75, 0.45, 0,    "成长"),
    ("quantum-loom",   "量子织机",  22,   1.09, 0.6,  0.7,  0.4,  "均衡"),
...
if __name__=="__main__":
    ...
    p.add_argument("--export-csv",type=str,help="保存CSV报告")
    a=p.parse_args()
    res=run_all(a.runs,a.seed)
    report(res)
    if a.export_csv:
        import csv
        with open(a.export_csv,"w",newline="") as f:
            w=csv.DictWriter(f,fieldnames=["name","tag","p10","p50","p90","avg_k","avg_lv","avg_it","dps"])
